...
public class StudentDAO {
	public List<Student> getAllStudents() throws Exception
	{
		...
		PreparedStatement preparedStatement = connection.prepareStatement(Constants.GET_ALL_STUDENTS );
	...
	public boolean insertStudentData(Student student) throws Exception
	{
		...
		PreparedStatement preparedStatement = connection.prepareStatement(Constants.INSERT_STUDENT_DATA );
