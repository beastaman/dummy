...
@WebServlet(name = "com.sapient.servlet.FirstServlet", value = "/com.sapient.servlet.FirstServlet")
public class FirstServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            printWriter.print("<center><form action = 'com.sapient.servlet.FirstServlet' method = 'post' >");
