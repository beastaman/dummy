...
<body>
    <center>
        ...
        <%
            } if(BookedTable==null && orderSummary.isEmpty()){
        %>
        <h5 style="text: red">Cart is empty</h5>
        <%
            }else{
        %>
        <form action="ConfirmationController" method="post">
            <input class="btn btn-warning" type="submit" name="confirm" value="confirmed">
        </form>
        <%
            }
        %>
