...
public class PriorityQueueInterface {
    public static void main(String[] args) {
        ...
        employeePriorityQueue.add(new Employee("Sachin Kamat", 100000.00));
        employeePriorityQueue.add(new Employee("Vikas", 145000.00));
        employeePriorityQueue.add(new Employee("Soumya Soubhagya Dandapat", 115000.00));
        employeePriorityQueue.add(new Employee("Wasim", 167000.00));
